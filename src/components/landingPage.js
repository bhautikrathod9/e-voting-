...
import logo from '../assets/logo1.png'; // Correct import for the logo
...
const styles = {
  ...
  navLinkHover: {
    color: '#ff007f', // This will be handled in the hover effect
  },
  loginButton: {
    padding: '10px 4px',
    color: 'white',
      ...
      <div style={styles.homePage}>
        ...
        <div style={styles.landingPage}>
          ...
          <div style={styles.content}>
            ...
            <button style={styles.startButton} onClick={handleStartClick}>Start</button>
          </div>
        </div>
      </div>
    );
